...
description: |
 "In this hands-on exercise, I will learn to use how to compute Global and Local Measures of Spatial Autocorrelation by using spdep package"
author:
  - name: Niharika Avula 
...
In the next two sections, geospatial data and its associated attribute table will be imported into R environment. 
* Geospatial data is in ESRI shapefile format 
* Attribute table is in csv format
...
Hunan_2012.csv will be imported into R by using read_csv() of readr package. The output is R dataframe class.
...
This section covers how to compute global spatial autocorrelation statistics and to perform spatial complete randomness test for global spatial autocorrelation.
...
This section covers how to perform Moran’s I statistics testing by using *moran.test()* of **spdep.**
...
Moran's I statistic value is 0.3 > 0, it is positive, and hence we can conclude that it is clustered and that the observations tend to be similar

### 6.1.1 Computing Monte Carlo Moran’s I
...
### 6.1.2 Visualising Monte Carlo Moran’s I
...
# 7. Global Spatial Autocorrelation: Geary’s

This section covers how to perform Geary’s c statistics testing by using appropriate functions of spdep package
...
Geary C value is 0.69 which is less than 1, hence it is clustered and observations tend to be similar

## 7.2 Computing Monte Carlo Geary’s C
...
P value is statistically significant at 99.9% confidence interval level and the z-score is positive. Hence null hypothesis can be rejected. The spatial distribution of high values in the dataset is more spatially clustered than would be expected if underlying spatial processes were truly random.

## 7.3 Visualising the Monte Carlo Geary’s C
...
## 8.1 Compute Moran’s I correlogram
...
## 9.2 Mapping the local Moran’s I
...
### 9.2.1 Mapping local Moran’s I values
...
### 9.2.2 Mapping local Moran’s P values
...
### 9.2.3 Mapping both local Moran’s I values and p-values
...
## 9.3 Creating a LISA Cluster Map

The LISA Cluster Map shows the significant locations color coded by type of spatial autocorrelation. The first step before we can generate the LISA cluster map is to plot the Moran scatterplot.

### 9.3.1 Plotting Moran scatterplot
...
### 9.3.2 Plotting Moran scatterplot with standardised variable
...
### 9.3.3 Preparing LISA map classes
...
### 11.1.1 Mapping Gi values with fixed distance weights
...
## 11.2 Gi statistics using adaptive distance
...
### 11.2.1 Mapping Gi values with adaptive distance weights
